...
function initNotesPage() {
  ...
  const WEB_APP_URL = "https://script.google.com/macros/s/AKfycbzxH9zRcHHmJGy9fu-fOQApzvIDwcfDjy6QmuKM2djjP61h8aKdYqNIKieNv6yNxoFe/exec"
  ...
  async function fetchNotes() {
    ...
    try {
      ...
      if (data && data.error) {
        throw new Error(data.error + (data.tip ? " Tip: " + data.tip : ""))
      }
      ...
      <div class="note-row fade-in">
        <div class="note-info">
          ...
          <div class="note-content">
            ...
            <p>Uploaded on ${note.dateCreated || "N/A"}</p>
          </div>
        </div>
        <div class="note-meta-row">
          <span><i class="fas fa-hdd"></i> ${note.size || "Unknown size"}</span>
          <span><i class="fas fa-calendar-alt"></i> ${note.dateCreated || "N/A"}</span>
        </div>
